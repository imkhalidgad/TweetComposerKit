...
#ifndef TWEETCOMPOSERKIT_SWIFT_H
#define TWEETCOMPOSERKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TweetComposerKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16TweetComposerKit18TwitterAuthManager")
...
@interface TwitterAuthManager (SWIFT_EXTENSION(TweetComposerKit)) <ASWebAuthenticationPresentationContextProviding>
